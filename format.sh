...
FILES=("$SRC_DIR/EiMOS_U8X8.cpp" "$SRC_DIR/EiMOS_U8X8.h" "$EX_DIR/ESP32_AMOS_MONSTER/ESP32_AMOS_MONSTER.ino" "$EX_DIR/MEGA2560_CENTURY_GOLD/MEGA2560_CENTURY_GOLD.ino" "$EX_DIR/PICO_AMOS_MONSTER/PICO_AMOS_MONSTER.ino")
